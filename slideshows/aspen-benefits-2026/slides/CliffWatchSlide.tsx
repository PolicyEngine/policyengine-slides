...
export default function CliffWatchSlide() {
  ...
  return (
    <Slide>
      <SlideHeader>
        <SlideTitle>See it live: where benefits cliff</SlideTitle>
      </SlideHeader>
        ...
        <div className="flex flex-col gap-4">
          <div className="content-card p-5">
            ...
            <p className="text-base text-gray-800 leading-relaxed">
              Live marginal tax-and-benefit rates across the whole earnings
              distribution &mdash; for any household, in any state, under any
              policy. Built entirely on the open rules.
            </p>
          </div>
          ...
          <div className="content-card p-5">
            ...
            <p className="text-base text-gray-700 leading-relaxed">
              A $1 raise can cost a family more than $1 once benefits phase out.
              This shows exactly where that happens &mdash; the kind of thing
              every screener and navigator needs, and almost none can compute.
            </p>
          </div>

          <div className="pl-5 border-l-4 border-pe-teal mt-auto">
            <p className="text-base text-gray-700 leading-relaxed italic">
              Any household, any state &mdash; live.
            </p>
          </div>
        </div>
