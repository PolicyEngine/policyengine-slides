...
export default function ThesisChildPovertySlide() {
  const [expanded, setExpanded] = useState(false);

  return (
    <Slide>
      <SlideHeader>
        <SlideTitle>Forecasting child poverty under current law</SlideTitle>
      </SlideHeader>
      ...
      >
        <iframe
          src={IFRAME_URL}
          title="Thesis — SPM child poverty rate forecast, 2025"
      ...
      {expanded && (
        ...
        >
          ...
          >
            <iframe
              src={IFRAME_URL}
              title="Thesis — SPM child poverty rate forecast, 2025 (expanded)"
