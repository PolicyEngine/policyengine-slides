...
const flow: { minutes: string; what: string; who: string }[] = [
  { minutes: '5 min', what: 'The new Census numbers and the SPM threshold calculator', who: 'Max Ghenis' },
  { minutes: '10 min', what: 'Remarks from guest speakers', who: 'Cynthia Osborne and Joshua McCabe' },
  { minutes: '10 min', what: 'PolicyEngine and microsimulation', who: 'Max Ghenis' },
