...
const flow: { minutes: string; what: string; who: string }[] = [
  { minutes: '5 min', what: 'The new Census numbers, the SPM and its threshold calculator, and what changed since 2024', who: 'Max Ghenis' },
  { minutes: '10 min', what: 'Remarks from guest speakers', who: 'Cynthia Osborne and Joshua McCabe' },
  { minutes: '10 min', what: 'PolicyEngine, microsimulation, and baselines vs. Census', who: 'Max Ghenis' },
