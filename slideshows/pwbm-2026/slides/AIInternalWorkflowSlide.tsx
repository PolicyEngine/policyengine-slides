...
export default function AIInternalWorkflowSlide() {
  const [hoveredSkill, setHoveredSkill] = useState<string | null>(null);

  return (
    <Slide>
      <SlideHeader>
        <SlideTitle>How we use AI: agent mesh for rule encoding</SlideTitle>
        <p className="text-xl text-gray-600 mt-2">
          One command drives twelve agents and six shared skills to a draft PR
      ...
      <div className="flex gap-6 h-[calc(100vh-280px)]">
        <div className="w-[65%] bg-[#f9f8f6] rounded-xl p-2 border border-gray-100 flex items-center justify-center">
          <svg className="full-width-flow-svg" viewBox="0 0 950 550" style={{ maxWidth: 850 }}>
            ...
            <text x="475" y="540" textAnchor="middle" fontFamily="JetBrains Mono" fontSize="10" fill="var(--text-mid)" fontStyle="italic">Hover a skill to see which agents use it</text>
          </svg>
        </div>
        ...
        <div className="w-[35%] flex flex-col">
          <div className="accent-block mb-5">
            <p className="text-gray-700 text-base">
              The workflow: <strong>12 agents</strong> and <strong>6 shared skills</strong>, triggered by one command. Agents iterate on tests until they pass; a human reviews the resulting PR.
            </p>
          </div>
          ...
          <div className="flex gap-3 mb-4">
            <div className="flex-1 content-card p-2 text-center">
              ...
              <div className="text-xs text-gray-500">minutes / PR</div>
            </div>
            <div className="flex-1 content-card p-2 text-center">
          ...
          <div className="p-3 bg-emerald-50 border border-emerald-200 rounded-xl mb-3">
            <span className="text-emerald-800 font-bold text-base">Output: </span>
            <span className="text-emerald-700 text-base">parameters, variables, tests, and a draft PR — all in one run.</span>
          </div>

          <div className="p-3 bg-amber-50 border border-amber-200 rounded-xl">
            <p className="text-amber-800 font-semibold text-base">
              The orchestrator never writes code itself — it invokes agents and checks quality gates.
            </p>
          </div>
        </div>
      </div>
