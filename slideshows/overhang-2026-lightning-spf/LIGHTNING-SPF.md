...
## 2 · How much will AI add to growth? Pick your study (0:45)
...
## 3 · Is there a series of forecasts we can score? Before Metaculus? (0:40)
...
## 4 · What the pros said about next year (0:55, two builds)
...
## 8 · The loop that matters most (0:40)
