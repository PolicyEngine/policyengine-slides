...
export function PolicyBenchSlide() {
  ...
  return <DeckFrame title="Without tools, the best model gets 89% of household answers right">
    ...
    <p className="mt-4 text-sm text-gray-500">Exact means within $1 for amounts and a match for eligibility, weighted across targets. The SNAP figure covers households with a positive reference benefit, all models.</p>
