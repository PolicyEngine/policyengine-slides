...
const IFRAME_URL = "https://app.thesisinstitute.org/spm-child-poverty-2025";
...
export default function ThesisDemoSlide() {
  ...
  return (
    <Slide>
      <SlideHeader>
        <SlideTitle>And forecasting every government number</SlideTitle>
      </SlideHeader>
      ...
      <div className="grid grid-cols-[0.7fr_1.3fr] gap-7 mt-4 h-[calc(100vh-300px)]">
        <div className="flex flex-col gap-4">
          <div className="content-card p-5">
            ...
            <p className="text-base text-gray-800 leading-relaxed">
              A live, sourced forecast &mdash; here, the child poverty rate.
              Every input is traceable, so you can see why the number moves, not
              just what it is.
            </p>
          </div>

          <div className="content-card p-5">
            <div className="slide-tag mb-3">The bigger idea</div>
            <p className="text-base text-gray-700 leading-relaxed">
              Agents read the evidence and assemble the forecast. The aim: every
              government metric, kept current &mdash; and re-runnable under any
        ...
        >
          <iframe
            src={IFRAME_URL}
            title="Thesis Institute forecast"
      ...
      {expanded && (
        ...
        >
          ...
          >
            <iframe
              src={IFRAME_URL}
              title="Thesis Institute forecast (expanded)"
