...
export default function ObbbaExplorerSlide() {
  ...
  return (
    <Slide>
      <SlideHeader>
        <SlideTitle>
          Same engine: who wins and loses under a real law
        </SlideTitle>
      </SlideHeader>
        ...
        <div className="flex flex-col gap-4">
          <div className="content-card p-5">
            ...
            <p className="text-base text-gray-800 leading-relaxed">
              The distributional impact of the One Big Beautiful Bill Act
              &mdash; traceable down to any household type, in any state, across
          ...
          <div className="content-card p-5">
            ...
            <p className="text-base text-gray-700 leading-relaxed">
              It&apos;s already law. This shows how it actually lands on real
              households &mdash; not a single headline number, but the gain or
              loss for a family like yours.
            </p>
          </div>

          <div className="pl-5 border-l-4 border-pe-teal mt-auto">
            <p className="text-base text-gray-700 leading-relaxed italic">
              Same engine, a bill that already passed.
            </p>
          </div>
        </div>
