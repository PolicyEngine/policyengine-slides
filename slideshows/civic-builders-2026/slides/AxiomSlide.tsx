    ...
    <Slide>
      ...
      <div className="grid grid-cols-[1.05fr_0.95fr] gap-8 mt-4 items-stretch">
        <div className="flex flex-col gap-4">
          <div className="content-card p-6">
            ...
            <p className="text-lg text-gray-700 leading-relaxed">
              ...
              &mdash; is hand-translated from statute into code. Slow, expensive,
              and the reason most of the law still isn&apos;t computable.
            </p>
          </div>
        ...
        <div
          ...
          style={{ background: 'linear-gradient(180deg, var(--pe-dark) 0%, var(--pe-darker) 100%)' }}
        >
          ...
          <p className="text-lg leading-relaxed text-white/85">
            ...
            PolicyEngine helps people understand the rules; Axiom makes the rules
            themselves computable.
          </p>

          <div className="mt-auto pt-4 border-t border-white/15">
            <p className="text-sm font-mono text-white/60">axiom-foundation.org</p>
          </div>
        </div>
      </div>
    </Slide>
