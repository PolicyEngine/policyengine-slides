      ...
      <div className="grid grid-cols-[0.7fr_1.3fr] gap-7 mt-4 h-[calc(100vh-300px)]">
        <div className="flex flex-col gap-4">
          <div className="content-card p-5">
            <div className="slide-tag mb-3">The bottleneck</div>
            <p className="text-base text-gray-800 leading-relaxed">
              Every rule PolicyEngine runs &mdash; the tax code, SNAP, the EITC
              &mdash; was hand-translated from statute. Slow, and the reason
              most of the law still isn&apos;t computable.
            </p>
          </div>

          <div className="content-card p-5">
            <div className="slide-tag mb-3">The shift</div>
            <p className="text-base text-gray-700 leading-relaxed">
              Now AI reads the statute and encodes it directly &mdash; every
              section, cross-reference, and definition, citation by citation.
            </p>
          </div>

          <div className="pl-5 border-l-4 border-pe-teal mt-auto">
            <p className="text-base text-gray-700 leading-relaxed italic">
              Live &mdash; let&apos;s open a provision.
            </p>
          </div>
        </div>
