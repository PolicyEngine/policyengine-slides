...
export default function ProblemSlide() {
  return (
    <Slide>
      <SlideHeader>
        <SlideTitle>
          The rules are public. Computing them isn&apos;t.
        </SlideTitle>
      </SlideHeader>
      ...
      <div className="accent-block mt-8">
        <p className="text-xl font-semibold text-gray-700 leading-relaxed">
          The tax-and-benefit code shapes every household &mdash; but the power
          to compute it has been locked inside agencies and consultancies.
        </p>
      </div>
    </Slide>
  );
