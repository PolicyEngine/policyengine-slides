...
export default function EverySeriesForecastSlide() {
  return (
    <Slide>
      <SlideHeader>
        <SlideTitle>What if every government series had a forecast?</SlideTitle>
      </SlideHeader>

      <div className="mt-8 grid grid-cols-[1fr_1fr] gap-10 items-stretch">
        <div className="space-y-5 flex flex-col justify-center">
          <p className="text-2xl text-gray-800 leading-relaxed">
            The federal statistical system already publishes millions of public
            statistical cells: series, geographies, income groups, industries,
            programs, and years.
          </p>
        ...
        <div className="content-card p-10 flex flex-col justify-center text-center">
          ...
          <p className="text-sm text-gray-500 italic leading-snug mt-8">
            A conservative order-of-magnitude floor: ACS alone can produce
            millions of geography-by-variable cells.
          </p>
        </div>
      </div>
    </Slide>
