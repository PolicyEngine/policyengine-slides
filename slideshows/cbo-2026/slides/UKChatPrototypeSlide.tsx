...
const IFRAME_URL = 'https://policyengine-uk-chat.vercel.app/';

export default function UKChatPrototypeSlide() {
  const [expanded, setExpanded] = useState(false);

  return (
    <Slide>
      <SlideHeader>
        <SlideTitle>Bringing it to anyone, not just agent users</SlideTitle>
      </SlideHeader>

      <div className="grid grid-cols-[0.7fr_1.3fr] gap-7 mt-4 h-[calc(100vh-300px)]">
        <div className="flex flex-col gap-4">
          <div className="content-card p-5">
            <div className="slide-tag mb-3">UK chat prototype</div>
            <p className="text-base text-gray-800 leading-relaxed">
              The Claude plugin gives you grounded answers if you already
              have Claude. This brings the same pattern to anyone &mdash;
              ask a tax-and-benefit question in plain English, get the
              answer back from the microsim, no extra tooling required.
            </p>
          </div>

          <div className="content-card p-5">
            <div className="slide-tag mb-3">Where this is going</div>
            <p className="text-base text-gray-700 leading-relaxed">
              UK first, US and other countries to follow. Same backend &mdash;
              encoded rules, calibrated microdata, agent that calls the
              right pieces &mdash; just a different surface so the audience
              is not limited to Claude Code users.
            </p>
          </div>

          <div className="pl-5 border-l-4 border-pe-teal mt-auto">
            <p className="text-sm text-gray-700 leading-relaxed italic">
              Same conductor-not-oracle pattern. Wider doorway.
            </p>
          </div>
        </div>
        ...
        >
          <iframe
            src={IFRAME_URL}
            title="PolicyEngine UK chat prototype"
      ...
      {expanded && (
        ...
        >
          ...
          >
            <iframe
              src={IFRAME_URL}
              title="PolicyEngine UK chat prototype (expanded)"
