    ...
    <Slide>
      ...
      <div className="mt-6 grid grid-cols-2 gap-6">
        ...
        <div className="flex flex-col gap-3">
          ...
          <div
            className="content-card overflow-hidden rounded-xl border border-gray-200 bg-white"
          ...
          <p className="text-sm text-gray-700 leading-snug">
            ...
            static PolicyEngine-US run, with explicit assumptions, citation
            to the IRS CTC page, distributional breakdown, and a ten-year
            range.
          </p>
        </div>
      </div>

      <p className="mt-5 text-base text-gray-600 italic text-center max-w-4xl mx-auto">
        Same prompt. Same model on the LLM side. What changed is that the
        agent had access to a calibrated microsim it could call &mdash; and
        the answer became grounded, specific, and citation-backed.
      </p>
    </Slide>
  );
}
