...
const IFRAME_URL = 'https://policyengine.org/us/cliffwatch';

export default function CliffWatchSlide() {
  const [expanded, setExpanded] = useState(false);

  return (
    <Slide>
      <SlideHeader>
        <SlideTitle>Encoded rules, in action: benefit cliffs</SlideTitle>
      </SlideHeader>

      <div className="grid grid-cols-[0.7fr_1.3fr] gap-7 mt-4 h-[calc(100vh-300px)]">
        <div className="flex flex-col gap-4">
          <div className="content-card p-5">
            <div className="slide-tag mb-3">CliffWatch</div>
            <p className="text-base text-gray-800 leading-relaxed">
              A live view of marginal tax-and-transfer rates across the full
              earnings distribution &mdash; for any household, in any state,
              under any policy. Built entirely on the encoded rules.
            </p>
          </div>
          ...
          <div className="content-card p-5">
            ...
            <p className="text-base text-gray-700 leading-relaxed">
              The same rules that score budget impacts also expose where
              programs interact &mdash; where benefits cliff, where marginal
              rates exceed 100%, where eligibility changes shape lifetime
              earnings.
            </p>
          </div>
          ...
          <div className="pl-5 border-l-4 border-pe-teal mt-auto">
            <p className="text-base text-gray-700 leading-relaxed italic">
              Same rules engine, completely different question.
            </p>
          </div>
        </div>
