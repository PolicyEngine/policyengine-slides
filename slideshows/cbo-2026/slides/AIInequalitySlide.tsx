...
const IFRAME_URL = 'https://policyengine.org/us/ai-inequality';
...
export default function AIInequalitySlide() {
  ...
  return (
    <Slide>
      <SlideHeader>
        <SlideTitle>This especially matters today</SlideTitle>
      </SlideHeader>

      <div className="grid grid-cols-[0.7fr_1.3fr] gap-7 mt-4 h-[calc(100vh-300px)]">
        <div className="flex flex-col gap-4">
          <div className="content-card p-5">
            <div className="slide-tag mb-3">High uncertainty</div>
            <p className="text-base text-gray-800 leading-relaxed">
              Forecasts of AI&apos;s impact on labor, productivity, the
              capital share, and inequality span a vast range &mdash; from
              boom to disruption to dislocation, often in the same paper.
            </p>
          </div>

          <div className="content-card p-5">
            <div className="slide-tag mb-3">Bigger change than usual</div>
            <p className="text-base text-gray-700 leading-relaxed">
              The central expectation across mainstream studies is greater
              economic change in the next decade than we have seen in any
              comparable window. Different studies disagree about the
              direction; almost none expect it to be small.
            </p>
          </div>

          <div className="pl-5 border-l-4 border-pe-amber mt-auto">
            <p className="text-base text-gray-800 leading-relaxed font-medium">
              And yet &mdash; who is thinking about the implications for
              public policy?
            </p>
          </div>
        </div>
        ...
        >
          <iframe
            src={IFRAME_URL}
            title="PolicyEngine AI inequality review"
      ...
      {expanded && (
        ...
        >
          ...
          >
            <iframe
              src={IFRAME_URL}
              title="AI inequality review (expanded)"
