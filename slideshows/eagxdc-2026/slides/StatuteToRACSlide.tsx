...
export default function StatuteToRACSlide() {
    ...
    <Slide>
      <SlideHeader>
        ...
        <p className="text-xl text-gray-600 mt-2">
          The .rac form is a prototype representation; the principle is that
          every statute has a parallel machine-readable encoding.
        </p>
      </SlideHeader>
      ...
      <div className="mt-4 pl-5 border-l-4 border-pe-teal">
        <p className="text-base text-gray-600 leading-relaxed">
          Each toggle pair becomes part of an open, citable corpus —
          accessible to humans, machines, and tools agents can call.
        </p>
      </div>
    </Slide>
  );
