      ...
      <div className="flex gap-8 h-[calc(100vh-280px)]">
        ...
        <div className="w-[60%] bg-[#f9f8f6] rounded-xl border border-gray-100 flex items-center justify-center p-3">
          <svg className="full-width-flow-svg" viewBox="0 0 600 490">
            ...
            <text x="5" y={skillY + skillHeight / 2 + 4} fontFamily="JetBrains Mono" fontSize="10" fill="var(--text-secondary)" fontWeight="600">Skills</text>
            {skills.map((skill) => {
            ...
            <text x="560" y={skillY + skillHeight / 2 + 4} textAnchor="middle" fontFamily="JetBrains Mono" fontSize="14" fill="var(--pe-teal)">...</text>
            <text x="310" y="480" textAnchor="middle" fontFamily="JetBrains Mono" fontSize="10" fill="var(--text-secondary)" fontStyle="italic">Hover over a skill to see which agents use it</text>
          </svg>
        </div>
